...
--------------------------------------------------
-- 🧪 FARM DE TRIAL: Explicação + Loop de Teleportes
--------------------------------------------------

Tabs.Main:AddParagraph({
    Title = "🧪 Farm de Trial",
    Content = "Este sistema de Auto Farm com loop de teleporte é específico para Trials. Ele alterna entre posições estratégicas para maximizar o ganho durante desafios."
})
